...
public class Interpreter
{
    ...
    public void execFunc(ListStm p, Env env, Function function, Type type){
        try{
            for (Stm x: p) {
                x.accept(new Interpreter.StmVisitor(), env);
            }
        }catch(Return val){
  ...
  public class ProgramVisitor implements Program.Visitor<Integer,Env>
  {
    public Integer visit(lang.Absyn.PStms p, Env env)
    ...
    public Integer visit(lang.Absyn.PFunctionalModeStms p, Env env)
